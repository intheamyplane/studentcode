...
public class Exercises {
    ...
    public String makeOutWord(String out, String word) {
        ...
        String answer = out.substring(0, 2) + word + out.substring(2);
    ...
    public String extraEnd(String str) {
        ...
        String answer = lastTwo + lastTwo + lastTwo;
    ...
    public String firstHalf(String str) {
        String answer = str.substring(0, str.length() / 2);
    ...
    public String left2(String str) {
        String answer = str.substring(2) + str.substring(0, 2);
        return answer;
    }
    ...
    public String right2(String str) {
        String answer = str.substring(str.length() - 2) + str.substring(0, str.length() - 2);
        return answer;
    }
    ...
    /*
     Give a string of even length, return a string made of the middle two chars, so the string "string"
    ...
    public String middleTwo(String str) {
        String answer = str.substring(str.length() / 2 - 1, str.length() / 2 + 1);
        return answer;
    }
...
//        String answer = str.substring(n, n + 2);
    ...
    public String middleThree(String str) {
        String evenString = str.substring(0, str.length());
        String answer = str.substring(evenString.length() / 2 - 1, evenString.length() / 2 + 2);
        return answer;
    ...
    //    String answer= str.substring(0,3);
        if(str.length()<=3){
       return str.repeat(n);
        }
        else {
    ...
    public boolean doubleX(String str) {
        int instanceX = str.indexOf("x");
        if(instanceX<str.length()-1){
            return str.charAt(instanceX+1) == 'x';
